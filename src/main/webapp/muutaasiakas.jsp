...
<link rel="stylesheet" type="text/css" href="/Etatehtava6/css/main.css">
...
$(document).ready(function(){
	...
	$.ajax({url:"asiakkaat/haeyksi/"+asiakas_id, type:"GET", dataType:"json", success:function(result){ //result on joko {"response:1"} tai {"response:0"}       
